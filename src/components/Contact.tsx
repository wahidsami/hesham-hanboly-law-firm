            ...
            <div className="lg:col-span-5 space-y-8 text-start">
              ...
              <div className="rounded-xl p-8 bg-[#F1ECE3] border border-[#D8D1C7] space-y-8">
                ...
                <div className="space-y-3 pt-6 border-t border-[#D8D1C7]/60">
                  <a href={`tel:${siteSettings?.phone || '0126630692'}`} className="flex items-center gap-3 text-sm text-[#1E1E1E] hover:text-[#A56A1E] justify-start transition-colors select-all">
                    <Phone className="w-4.5 h-4.5 text-[#A56A1E]" />
                    <span className="font-mono">
                      {siteSettings?.phone || '0126630692'} • {t(
                        siteSettings?.contactSectionPhoneLabelAr || 'الهاتف الموحد',
                        siteSettings?.contactSectionPhoneLabelEn || 'Unified Number'
                      )}
                    </span>
                  </a>
                  <a href={`mailto:${siteSettings?.email || 'mec_law@hotmail.com'}`} className="flex items-center gap-3 text-sm text-[#1E1E1E] hover:text-[#A56A1E] justify-start transition-colors select-all">
                    <Mail className="w-4.5 h-4.5 text-[#A56A1E]" />
                    <span className="font-mono">
                      {siteSettings?.email || 'mec_law@hotmail.com'} • {t(
